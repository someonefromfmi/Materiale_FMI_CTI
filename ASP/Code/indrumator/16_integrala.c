...
int main(int argc, char** argv) {
    ...
    if(rank == 0) {
        ...
        for(i=1;i<Np;i++) {
            // trimite interv de integr [c1, c2]
        ...
        // primeste rez integralelor si calc rez fin
        for(i=1;i<Np;i++) {
        ...
        // calc integrala pe interv [c1, c2]
